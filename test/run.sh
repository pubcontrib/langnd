...
testscripts()
{
    ...
    pass '@write(@stringify(@or(false, false)), 1)' 'false'
    pass '@write(@stringify(@or(false, true)), 1)' 'true'
    pass '@write(@stringify(@or(true, false)), 1)' 'true'
    pass '@write(@stringify(@or(true, true)), 1)' 'true'
    pass '@write(@stringify(@not(false)), 1)' 'true'
    pass '@write(@stringify(@not(true)), 1)' 'false'
